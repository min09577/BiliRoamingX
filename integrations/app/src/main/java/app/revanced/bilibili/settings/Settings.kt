...
object Settings {
    ...
    @JvmField val DanmakuShadowStyle = IntSetting(key = "danmaku_shadow_style", defValue = 0)
    ...
    @JvmField val CommentAutoFold = BooleanSetting(key = "comment_auto_fold")
    ...
    @JvmField val DanmakuSendFontCustom = IntSetting(key = "danmaku_send_font_custom", defValue = 0)
    ...
    @JvmField val DynamicAutoPin = BooleanSetting(key = "dynamic_auto_pin")
    @JvmField val SearchAutoCorrection = BooleanSetting(key = "search_auto_correction")
    ...
    @JvmField val CommentAutoCollapseOld = BooleanSetting(key = "comment_auto_collapse_old")
    ...
    @JvmField val DanmakuFontOutlineWidth = FloatSetting(key = "danmaku_font_outline_width", defValue = 0f)
    ...
    @JvmField val DanmakuSendConfirmDialog = BooleanSetting(key = "danmaku_send_confirm_dialog")
    ...
    @JvmField val HomeFeedAutoNightMode = BooleanSetting(key = "home_feed_auto_night_mode")
    @JvmField val DynamicAutoPinTop = BooleanSetting(key = "dynamic_auto_pin_top")
    @JvmField val CommentAutoPinTop = BooleanSetting(key = "comment_auto_pin_top")
    ...
    @JvmField val HomeFeedAutoNightSchedule = BooleanSetting(key = "home_feed_auto_night_schedule")
    ...
    @JvmField val DanmakuFontWeightCustom = IntSetting(key = "danmaku_font_weight_custom", defValue = 0)
    ...
    @JvmField val DanmakuSendPreviewFull = BooleanSetting(key = "danmaku_send_preview_full")
