...
req = urllib.request.Request("https://api.github.com/repos/min09577/BiliRoamingX/releases/tags/v1.81.0")
...
apk_path = "integrations/app/build/outputs/apk/release/BiliRoamingX-integrations-1.81.0.apk"
...
for attempt in range(5):
    try:
        upload_req = urllib.request.Request(
            upload_url + "?name=BiliRoamingX-integrations-1.81.0.apk",
