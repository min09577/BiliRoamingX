...
> **⚠️ AI 自我维护迭代升级版本**
>
> 本项目是基于 [BiliRoamingX](https://github.com/BiliRoamingX/BiliRoamingX) 的 AI 维护分支，由 AI 进行持续迭代开发和维护。
> 项目名称后缀 `-AI` 表示该版本由人工智能驱动开发和升级。
>
> **原始项目作者**: [BiliRoamingX 团队](https://github.com/BiliRoamingX)
> **AI 维护者**: [@min09577](https://github.com/min09577)

---

基于 ReVanced 实现的某站 Android 客户端增强模块。模块设置完美融入 APP 设置，功能丰富，自定义程度高。
...
```shell
git clone --recurse-submodules https://github.com/min09577/BiliRoamingX.git
cd BiliRoamingX
./gradlew dist
```
