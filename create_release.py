...
data = json.dumps({
    "tag_name": "v1.70.0",
    "name": "v1.70.0",
    "body": "v1.70.0 - 视频自动变速、用户弹幕高亮、评论图片压缩、字幕同步",
    "draft": False,
    "prerelease": False
}).encode()
...
try:
    ...
    apk_path = "integrations/app/build/outputs/apk/release/BiliRoamingX-integrations-1.70.0.apk"
    with open(apk_path, "rb") as f:
        apk_data = f.read()

    upload_req = urllib.request.Request(
        upload_url + "?name=BiliRoamingX-integrations-1.70.0.apk",
